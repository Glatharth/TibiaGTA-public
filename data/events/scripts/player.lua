...
function Player:onLook(thing, position, distance)
	...
	if (thing:isCreature() and thing:isNpc() and distance <= minDist and self:getStorageValue(_Sistemas[2].storage) == 1 and _Sistemas[2].enable == 1) then
...
function Player:onLookInBattleList(creature, distance)
	...
	self:sendTextMessage(MESSAGE_INFO_DESCR, description)
	if (creature:isNpc() and distance <= minDist and self:getStorageValue(_Sistemas[2].storage) == 1 and _Sistemas[2].enable == 1) then
